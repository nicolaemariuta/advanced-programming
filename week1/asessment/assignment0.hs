...
--types and functions for representing and creating the Curve 
data Point = Point { x :: Double, y :: Double} deriving (Show)
type Curve = [Point]

--construct Point from a pair of coordinates
...
--make Point instance of Eq
instance Eq Point where
	a == b = comparePoints a b
	a /= b = not (comparePoints a b)

--creates a curve that starts from Point and continues with a list of Points
...
--rotates the points using the mathematical formula
...
--applies the function rotatePoint for each point in the Curve
